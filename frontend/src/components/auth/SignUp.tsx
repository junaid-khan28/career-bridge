          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 pl-12 border-2 transition-all duration-200 focus:border-primary focus:shadow-glow/50 relative"
              />
              <User className="absolute left-4 top-[38px] h-4 w-4 text-muted-foreground pointer-events-none" />
            </div>
